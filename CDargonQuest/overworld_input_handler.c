...
{
   dqOverworldInputHandler = (dqOverworldInputHandler_t*)dqMalloc( sizeof( dqOverworldInputHandler_t ), sfTrue );
...
{
   dqFree( dqOverworldInputHandler, sizeof( dqOverworldInputHandler_t ), sfTrue );
}
